...
function App() {
  ...
  useEffect(() => {
    ...
    `url(https://images.pexels.com/photos/4386442/pexels-photo-4386442.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)`}}>
      <div className='w-full'>
        ...
        bg-white/30'>
          <form onSubmit={(e)=>e.preventDefault()}>
            ...
            <label className='bg-blue-600 text-white px-4 py-3 rounded-lg text-center w-full max-w-md'>
